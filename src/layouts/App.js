...
class App extends React.PureComponent {
	...
	onAddLayout = (component, name, config) => {
		const { t } = this.props
			...
			<div className="app">
				...
				>
					<Router >
						<Trans>
							<Route exact path="/">
								<MenubarChildDown active_components={this.active_components} get_value_from_glb_sv_seq={this.get_value_from_glb_sv_seq} onAddLayout={this.onAddLayout} ></MenubarChildDown>
