...
class AddOrder extends React.PureComponent {
  ...
  */
    ...
    selectedStk = selected => {
        ...
        inform_broadcast(`${commuChanel.RESET_CHART_INTRADAY}_${this.component}`);
    ...
    toggle = (key) => {
        if (key === 1) {
            ...
            // this.setState({
            //   tooltipOpen_temporary_fee: !this.state.tooltipOpen_temporary_fee
            // });
        } else if (key === 8) {
            this.setState({
    ...
    handleKeyPress = e => {
        ...
        if (name === 'qty' || name === 'price') {
            this.placeOrder()
        } else if (name === 'otpNumOrder' && this.otpNum && this.otpNum.length === 6) {
            this.sendOtpFunct()
        }
    }
                    ...
                    <div className="padding5 flex-2" style={{ minWidth: 430 }}>
                        <div className="card" style={{ height: '100%' }}>
                            <div className="card-body">
                                ...
                                <div id={this.component + "order_exten_under"} style={{ marginTop: 5, paddingTop: 18 }}>
                                    <div
