...
class AssetManage extends PureComponent {
    ...
    componentDidMount() {
        ...
        if (this.props.node) this.loadData(glb_sv.activeAcnt)
    ...
    componentWillUnmount() {
        ...
        // elemm.style.top = ''
        // elemm.style.width = ''
        // if (elemm.classList.contains('width_asset')) {
        //     elemm.classList.remove('width_asset')
        // }
    }
    ...
    getassetStockInfoList = () => {
        ...
        // svInputPrm.InVal = ['02', this.actn_curr, this.sub_curr]
    ...
    handleKeyPress = e => {
        ...
        // if (this.state.selectedStkName && code === 13) {
        //   this.getPortfolioList();
        // } else if (this.state.selectedStkName && code === 13) {
        //   this.getPortfolioList();
        // }
    }
    ...
    handleSubChoose = () => {
        this.setState({ subChoose: !this.state.subChoose })
        setTimeout(() => {
            this.getassetTotalInfo()
            this.getassetStockInfoList()
            this.getPortfolioList()
        ...
        return (
            <div className="AssetManage__layout">
                <div className="width-assets">
                    <div className="col-5 marginBottom5">
                        <SearchAccount
                    ...
                    <div className="card asset asset-margin">
                        <div className="card-body" style={{ padding: 0, overflow: 'auto' }}>
                            ...
                            <Nav tabs role="tablist">
                                {(this.state.activeCode === '888' || this.state.activeCode === '061') && (
                                    <>
                                        <NavItem>
                                            <NavLink>
                                                <input
                                                    type="radio"
                                                    id="choose_subacount_asset"
                                                    name="choose_subacount_asset_nm"
                                                    value={true}
                                                    checked={this.state.subChoose}
                                                    onChange={this.handleSubChoose}
                                                />
                                                <label htmlFor="choose_subacount_asset" style={{ fontSize: 14 }}>
                                                    {t('asset_of_sub_account')}
                                                </label>
                                        ...
                                        <NavItem>
                                            <NavLink>
                                                <input
                                                    type="radio"
                                                    id="choose_acount_asset"
                                                    name="choose_acount_asset_nm"
                                                    value={false}
                                                    checked={!this.state.subChoose}
                                                    onChange={this.handleSubChoose}
                                                />
                                                <label htmlFor="choose_acount_asset" style={{ fontSize: 14 }}>
                                                    {t('all_asset_of_customer')}
                                                </label>
                                                {/* <div className="check"></div> */}
                                            </NavLink>
                                        </NavItem>
                            ...
                            <div className="tab-content top">
                                <div className={"tab-pane"} style={{ display: this.state.activeTab === '1' ? 'block' : 'none' }} id="assetInfo" aria-expanded="true" role="tabpanel">
                                    ...
                                    <div className="card card-outline-default" style={{ marginBottom: 0 }}>
                                        <div className="card-body" style={{ borderTop: 0 }}>
                                            <div className="card-title">
                                                ...
                                                <span
                                                    className="transition cursor_ponter"
                                                ...
                                                <span
                                                    className="transition  cursor_ponter"
                                                    onClick={this.handleShow}
                                                    style={{ display: this.state.iconDOWN }}
                                                >
                                ...
                                <div className={"tab-pane"} style={{ display: this.state.activeTab === '2' ? 'block' : 'none' }} id="listOwnStock" aria-expanded="false" role="tabpanel">
                                    <div className="card card-outline-default" style={{ marginBottom: 0 }}>
                                        <div
                                            className="card-body row"
                                            style={{ minHeight: 'unset', margin: 0, borderBottom: 0 }}
                                        >
                                            <div className="form-group row col-6">
                                                <label className="col-2 control-label no-padding-right marginAuto">
                                                    {t('common_from_date')}
                                                    <span className="mustInput">*</span>
                                                </label>
                                                <div className="col-4 marginAuto">
                                                    <DatePicker
                                                        id="dateAstMng1"
                                            ...
                                            <div className="form-group row col-6">
                                                {this.state.isChangeTheme && (
                                                    <Select
                                                        ...
                                                        className="col-6 marginAuto"
                                                        value={this.state.selectedStkName}
                                                        onChange={this.selectedStk}
                                                        ...
                                                        theme={theme => ({
                                                            ...
                                                            colors: {
                                                                ...
                                                                text: '',
                                                                primary25:
                                                                    glb_sv.style[glb_sv.themePage].sideBar
                                                                        .background_hover_search,
                                                                neutral0:
                                                                    glb_sv.style[glb_sv.themePage].sideBar
                                                                        .background_search,
                                                            },
                                                ...
                                                <div className="offset-sm-1 col-5">
                                                    <button
                                                        onClick={this.getPortfolioList}
                                                        id="getInvestPortfolioBt"
                                                        className="btn btn-block btn-sm btn-info"
                                                        style={{ height: 26 }}
                                                    >
                                                        {this.state.getPortfolioListFlag ? (
                                                            <span>
                                                                {t('common_processing')}
                                                                <i className="fa fa-circle-o-notch fa-spin fa-lg fa-fw"></i>
                                                            </span>
                                                        ) : (
                                                                <span>{t('common_button_sumbit_select')}</span>
                                                            )}
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    {/* Table thông tin danh mục đầu tư */}
                                    <div className="card card-outline-default" style={{ marginBottom: 0 }}>
                                        <div className="card-body" style={{ minHeight: 180, borderTop: 0 }}>
                                            <div className="card-title">
                                                {t('investment_portfolio')} - {t('acnt_no')}:{' '}
                                                {this.state.assetInfo_acntNo.substr(0, 10)}{' '}
                                                <button className="btn btn-sm btn-link undecoration excel_button_blue">
                                                    <CSVLink
                                                        filename={t('investment_portfolio') + '.csv'}
                                                        data={this.state.dataExcel_invest}
                                                        headers={this.headersCSV_invest}
                                                        target="_blank"
                                                    >
                                                        <span id="Tooltip_csv2" style={{ padding: 0, marginBottom: 5 }}>
                                                            <IconExcel />
                                                        </span>
                                                    </CSVLink>
                                                </button>
                                                <Tooltip
                                                    placement="top"
                                                    isOpen={this.state.tooltipOpen_csv2}
                                                    target="Tooltip_csv2"
                                            ...
                                            >
                                                <table
                                                    className="table_sticky_invest tableNormal table table-sm tablenowrap table-bordered table-striped"
                                                    style={{ marginBottom: 6 }}
                                                >
                                                    <thead className="header">
                                                        <tr>
                                                            <th className="text-center" id="fix-first-col">
                                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c3', 'invest')}
                                                            >
                                                                {t('short_symbol')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c0', 'invest')}
                                                            >
                                                                {t('calculator_date')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c2', 'invest')}
                                                            >
                                                                {t('sub_account')}
                                                            </th>
                                                            ...
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c21', 'invest')}
                                                            >
                                                                {t('buy_average_price')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c22', 'invest')}
                                                            >
                                                                {t('buy_average_value')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c23', 'invest')}
                                                            >
                                                                {t('profit_loss_ratio')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c15', 'invest')}
                                                            >
                                                                {t('profit_loss_value')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c4', 'invest')}
                                                            >
                                                                {t('own_qty')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c5', 'invest')}
                                                            >
                                                                {t('increase_quantity')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c6', 'invest')}
                                                            >
                                                                {t('value_of_capital')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c7', 'invest')}
                                                            >
                                                                {t('decrease_quantity')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c8', 'invest')}
                                                            >
                                                                {t('value_of_cash_right')}
                                                            </th>
                                                            {glb_sv.activeCode != '028' && (
                                                                <th
                                                                    className="text-center cursor_ponter"
                                                                    onClick={() => this.sortTable('c9', 'invest')}
                                                                >
                                                                    {t('quantity_of_stock_right')}
                                                                </th>
                                                            )}

                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c10', 'invest')}
                                                            >
                                                                {t('accumulated_capital_value_excluding_rights')}
                                                            </th>

                                                            {glb_sv.activeCode != '028' && (
                                                                <th
                                                                    className="text-center cursor_ponter"
                                                                    onClick={() => this.sortTable('c11', 'invest')}
                                                                >
                                                                    {t('value_of_stock_right')}
                                                                </th>
                                                            )}
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c12', 'invest')}
                                                            >
                                                                {t('quantity_of_current_stock')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c13', 'invest')}
                                                            >
                                                                {t('market_price')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c14', 'invest')}
                                                            >
                                                                {t('market_value')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c16', 'invest')}
                                                            >
                                                                {t('previous_transaction_date')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c17', 'invest')}
                                                            >
                                                                {t('selling_value_on_the_property_value')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c18', 'invest')}
                                                            >
                                                                {t('profit_loss_value_sell_on_day')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c19', 'invest')}
                                                            >
                                                                {t('profit_loss_value_buy_on_day')}
                                                            </th>
                                                            <th
                                                                className="text-center cursor_ponter"
                                                                onClick={() => this.sortTable('c20', 'invest')}
                                                            >
                                                                {t('total_profit_loss_value_on_day')}
                                                            </th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        {this.state.data_invest.map(item => (
                                                            <tr key={_.uniqueId('keyinvest')}>
                                                                <td
                                                                    className="text-center"
                                                                    style={{ whiteSpace: 'nowrap' }}
                                                                >
                                                                    <button
                                                                        ...
                                                                        onClick={() => this.openInvestDeatailModal(item)}
                                                                    >
                                                                        {t('common_detail_info')}
                                                                    </button>
                                                                </td>
                                                                ...
                                                                <td className="text-right">{FormatNumber(item['c21'])}</td>
                                                                <td className="text-right">{FormatNumber(item['c22'])}</td>
                                                                <td
                                                                    className={
                                                                        'text-right ' +
                                                                        (item.c23 < 0
                                                                ...
                                                                >
                                                                    ...
                                                                    {item['c23'] < 0
                                                                        ? FormatNumber(item['c23'] * -1, 3)
                                                                        : item.c23 !== 100 && item.c23 !== 0
                                                                            ? FormatNumber(item['c23'], 3)
                                                                            : item.c23}{' '}
                                                                    %
                                                                </td>
                                                                <td
                                                                ...
                                                                <td className="text-right">{FormatNumber(item['c12'])}</td>
                                                                <td className="text-right">{FormatNumber(item['c13'])}</td>
                                                                <td className="text-right">{FormatNumber(item['c14'])}</td>
                                                                <td className="text-right">{FormatNumber(item['c16'])}</td>
                                                                <td className="text-right">{FormatNumber(item['c17'])}</td>
                                                                <td
                                                                    className={
                                                                ...
                                                                >
                                                                    {FormatNumber(item['c20'])}
                                                                </td>
                                                            </tr>
                                                        ))}
                                                        {this.state.data_invest && this.state.data_invest.length === 0 && (
                                                            <tr>
                                                    ...
                                                    <tfoot>
                                                        {this.state.data_invest && this.state.data_invest.length !== 0 && (
                                                            <tr className="row-for-sum">
                                                                ...
                                                                <td className="text-right">
                                                                    {FormatNumber(this.state.total_invest.c22)}
                                                                </td>
                                                                <td>
                                                                    <div
                                                                        className={
                                                                            'text-right ' +
                                                                            (this.state.total_invest.c15 < 0
                                                                                ? 'price_basic_less'
                                                                                : this.state.total_invest.c15 > 0
                                                                                    ? 'price_basic_over'
                                                                                    : '')
                                                                    ...
                                                                    >
                                                                        ...
                                                                        {this.state.total_invest.c22 == 0
                                                                            ? 0
                                                                            : Math.round(
                                                                                (Math.abs(this.state.total_invest.c15) /
                                                                                    this.state.total_invest.c22) *
                                                                                100 *
                                                                                1000
                                                                            ) / 1000}{' '}
                                                                        %
                                                                ...
                                                                <td className="text-right" />
                                                                <td className="text-right">
                                                                    {FormatNumber(this.state.total_invest.c5)}
                                                                </td>
                                                                <td className="text-right" />
                                                                <td className="text-right">
                                                                    {FormatNumber(this.state.total_invest.c7)}
                                                                </td>
                                                                {glb_sv.activeCode != '028' && (
                                                                    <td className="text-right">
                                                                        {FormatNumber(this.state.total_invest.c8)}
                                                                    </td>
                                                                )}
                                                                <td className="text-right">
                                                                    {FormatNumber(this.state.total_invest.c9)}
                                                                </td>
                                                                <td className="text-right" />
                                                                {glb_sv.activeCode != '028' && (
                                                                    <td className="text-right">
                                                                        {FormatNumber(this.state.total_invest.c11)}
                                                                    </td>
                                                                )}
                                                                <td className="text-right" />
                                                                <td className="text-right" />
                                                                <td className="text-right">
                                                                    {FormatNumber(this.state.total_invest.c14)}
                                                                </td>
                                                                <td className="text-right" />
                                                                <td className="text-right" />
                                                                <td
                                                                ...
                                                                >
                                                                    {FormatNumber(this.state.total_invest.c18)}
                                                                </td>
                                                                <td
                                                                    className={
                                                                        'text-right ' +
                                                                        (this.state.total_invest.c19 < 0
                                                                            ? 'price_basic_less'
                                                                            : this.state.total_invest.c19 > 0
                                                                                ? 'price_basic_over'
                                                                                : '')
                                                                ...
                                                                >
                                                                    {FormatNumber(this.state.total_invest.c19)}
                                                                </td>
                                                                <td
                                                                    className={
                                                                        'text-right ' +
                                                                        (this.state.total_invest.c20 < 0
                                                                            ? 'price_basic_less'
                                                                            : this.state.total_invest.c20 > 0
                                                                                ? 'price_basic_over'
                                                                                : '')
                                                                ...
                                                                >
                                                                    {FormatNumber(this.state.total_invest.c20)}
                                                                </td>
                                                            </tr>
                                                        )}
                                                    </tfoot>
