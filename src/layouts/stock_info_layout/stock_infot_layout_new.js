...
export default class TVChartContainer extends React.PureComponent {
    constructor(props) {
        super(props)
        this.glb_sv = this.props.glb_sv
        this.socket_sv = this.props.socket_sv
    ...
    render() {
        ...
        return <div id='tv_chart_container' style={{height: 'calc(100vh - 116px)'}} >
            <iframe id='iframe' frameBorder="0" src={`http://finance.ivs.com.vn/${lang}/Stock/acb`} height="100%" width="100%"></iframe>
        </div>
    }
}