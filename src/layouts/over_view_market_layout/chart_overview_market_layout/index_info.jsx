...
class IndexInfo extends React.PureComponent {
    ...
    procFlash = (message) => {
        ...
        const id = '#' + itemArr[0] + this.component;
            ...
            <>
                ...
                <div className="indexInfo" style={this.props.full ? {} : {display: 'inline-block'}}>
                    <div className="clearfix indexNm" >
                        <div className="text-center indexInfoCell">
                            ...
                            <span className={colorIndexNm} style={{textShadow: '0.1px 0.1px 0.1px red'}}>
                                <span className="indexValue" id={'indexValue' + this.props.keyIndex + this.component}>{FormatNumber(objShareInfoIndex['indexValue'], 2, 0)+' '}</span>
                                ...
                                <span className="indexTg" id={'indexValueChang' + this.props.keyIndex + this.component}>{FormatNumber(Math.round(objShareInfoIndex['indexValueChang']*100)/100, 2, 0)}{' '}
                    ...
                    <div className="clearfix indexCP">
                        <div className="text-center indexInfoCell">
                            <span className="indexTotalQty" id={'indexTotalQty' + this.props.keyIndex + this.component}>{FormatNumber(objShareInfoIndex['indexTotalQty'], 0, 0)}{' '}</span>
                            <span className="indextext_color">{t('shares')}</span>&nbsp;
                            <span className="indexTotalValue" id={'indexTotalValue' + this.props.keyIndex + this.component}>{FormatNumber(objShareInfoIndex['indexTotalValue'], 3, 0)}{' '}</span>
