    ...
    return (
      <section className='' id='left-sidebar'>
        <ul className="sidebar__ul__layout" data-tut="reactour__menu_view">
          ...
          <Menubar active_components={this.props.active_components} get_value_from_glb_sv_seq={this.props.get_value_from_glb_sv_seq} onAddLayout={this.props.onAddLayout} component={this.component}></Menubar>
        </ul>
