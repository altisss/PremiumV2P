...
// , (prevProps, nextProps) => {
//   if (prevProps.node.data == null || nextProps.node.data == null) return false;
//   const result = isEqual(prevProps.node.data.list,nextProps.node.data.list) && prevProps.node.data.indexValueChang === nextProps.node.data.indexValueChang && prevProps.node.data.indexPercChang === nextProps.node.data.indexPercChang
//     && prevProps.node.data.indexValue === nextProps.node.data.indexValue && prevProps.isOpen=== nextProps.isOpen;
//   return result;
// }
