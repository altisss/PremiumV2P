      ...
      <>
        {this.state.isBroker ? <>
          <div className='col-sm no-padding-left no-padding-right' style={{ display: 'flex', flex: 1, flexDirection: 'row' }}>
            ...
            <div className={'fix-width no-padding-right no-padding-left ' + (this.props.isShowSubno ? this.transCol(SubNo.length) : ' col-11')}>
              <select
            ...
            <div className="col no-padding flex no-margin-right no-margin-left">
              {this.props.isShowSubno && <div
