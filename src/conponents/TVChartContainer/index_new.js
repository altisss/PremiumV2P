...
class TradingViewContainer extends PureComponent {
    constructor(props) {
        ...
        // if (stk && stk.trim().length > 0) {
        //     sessionStorage.setItem('stkNm', stk)
        //     sessionStorage.setItem('lang', lang)
        // }
        // if (!glb_sv.tradingViewPage) {
        //     glb_sv.tradingViewPage = true
        //     this.props.history.push('/main-app')
        // }
        this.styleTV = { width: '100%', position: 'relative', minHeight: 610, overflow: 'auto' }
    }
    ...
    render() {
        return (
            <>
                <div id="tv_chart_container" className="TVChartContainer fix" style={this.styleTV} />
            </>
        )
    }
}
